...
+ [Results_on_all_instances/result_all.csv](experimental_results/Results_on_all_instances/result_all.csv): Results of *SplitCA*, *HSCA* and *AutoCCAG* on all of the instances.
